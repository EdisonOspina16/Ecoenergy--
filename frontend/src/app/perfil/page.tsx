...
export default function Profile() {
  ...
  const handleDeleteDevice = async (id: number) => {
    ...
    try {
      const response = await fetch(
        `http://localhost:5000/perfil/dispositivo/${id}`,
        {
          method: "DELETE",
          credentials: "include",
        },
      ...
      if (data.success) {
        ...
        mostrarMensaje(
          "error",
          data.error || "Error al eliminar el dispositivo",
        );
      }
    } catch (error) {
  ...
  const handleToggleConnection = async (id: number) => {
    try {
      ...
      const response = await fetch(
        `http://localhost:5000/perfil/dispositivo/${id}/estado`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
      ...
      if (!data.success) {
        ...
        mostrarMensaje(
          "success",
          `Dispositivo ${!device.connected ? "conectado" : "desconectado"}`,
        );
      }
    } catch (error) {
      ...
      <header className={styles.header}>
        <div className={styles.headerContent}>
          ...
          <nav className={styles.nav}>
            ...
            <a href="/reportes" className={styles.navLink}>
              Reports
            </a>
            <a href="/perfil" className={styles.navLinkActive}>
              Profile
            </a>
          </nav>
        ...
        <div className={styles.mainContent}>
          ...
          <div className={styles.pageHeading}>
            ...
            <p className={styles.pageDescription}>
              Gestiona la información de tu hogar y monitorea tus dispositivos
              conectados.
            </p>
          </div>
              ...
              <section className={styles.card}>
                ...
                <div className={styles.cardBody}>
                  {devices.length === 0 ? (
                    ...
                    >
                      No tienes dispositivos registrados. Registra uno usando el
                    ...
                    <ul className={styles.deviceList}>
                      {devices.map((device) => (
                        <li key={device.id} className={styles.deviceItem}>
                          <div
                            className={`${styles.deviceIcon} ${device.connected ? styles.deviceIconConnected : styles.deviceIconDisconnected}`}
                          >
                          ...
                          <div
                            className={`${styles.deviceStatus} ${device.connected ? styles.deviceStatusConnected : styles.deviceStatusDisconnected}`}
                          >
